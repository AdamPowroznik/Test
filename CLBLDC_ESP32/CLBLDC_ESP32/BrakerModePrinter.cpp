...
void BrakerModePrinter::updateValues()
{
	RPM = worker->SPEED;
...
BrakerModePrinter::BrakerModePrinter(LiquidCrystal_I2C &lcd, BrakerMode &worker, String name) :Printer(lcd)
{
	this->name = name;
	this->worker = &worker;
	updateValues();
...
BrakerModePrinter::~BrakerModePrinter()
{

}

void BrakerModePrinter::Print()
{
...
void BrakerModePrinter::InitPrint()
{
	updateValues();
